...
if __name__ == '__main__':
    ...
    for country in country_codes:
        ...
        if prompt.lower() == 'y':
            ...
            with open(f'{date}/{country[0]}_{date}.txt','r') as f1:
                description = f1.read() #reads the entire file
                #print(description)

            category = '25'
            keywords = f'news, 1, one, minute, one minute, headline, {date}, {country[0]}'
            ...
            args = argparser.parse_args(["--file", filepath]) #need to put this in at least to create it? since required? im not sure
            args.title = title
            args.description = description
            args.category = category
            args.keywords = keywords
            args.privacyStatus = privacy
